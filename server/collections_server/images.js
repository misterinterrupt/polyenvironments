...
Images = new FS.Collection("images", {
  stores: [
    new FS.Store.S3("thumbs", {
      ...
      accessKeyId: process.env.accessKeyId, //required if environment variables are not set
      secretAccessKey: process.env.secretAccessKey, //required if environment variables are not set
